...
```{r The Plot, message = FALSE, warning=FALSE}
...
Box_Office %>% group_by(m) %>% plot_ly(x=~day, y= ~money_total, hoverinfo= "text") %>% 
  ...
  add_segments(x = 0, xend = nrow(Box_Office_SH), y = 42000000, yend = 42000000, color= I("red"), text= "$42 Million: Holmes and Watson") %>%
  add_segments(x = 0, xend = 59, y = 65000000, yend =65000000, color= I("blue"), text= "$65 Million: Step Brothers") %>%
  add_segments(x = 0, xend = 65, y = 72500000, yend = 72500000,color= I("green"), text= "$72.5 Million: Talladega Nights")
...
plot_2 <- plot_ly(box_data_bb, x=~day, y= ~total, hoverinfo= "text", mode = "markers") %>%
